...
file_uat = [{
            ...
            {
                "fileId": "664469140182327296",   # 纳税信用评级
                "fileName": "wx_camera_1703140202782.jpg",
                "subCategoryCode": "taxCreditRating",
            },
            {
            ...
            {
                "fileId": "609095475618373632",  # 合同公司J1租赁设备采购合同-uat
            ...
            {
                "fileId": "622098847631597568",  #合同公司J1租赁设备采购合同
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:311225",
            },
            {
                "fileId": "622098847631597568",  #合同公司J2租赁设备采购合同
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:311258",
            },
            {
                "fileId": "632606562032513024",  #合同公司J3租赁设备采购合同
                "fileName": "1694500730-origin-IMG_0085.JPG",
                "subCategoryCode": "rentalEquipProcurementContract:10149",
            },
            {
                "fileId": "622098847631597568",  #测试Z500公司F4租赁设备采购合同
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:9837",
            },
            {
                "fileId": "622098847631597568",  #测试Z500公司F2租赁设备采购合同
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:10156",
            },
            {
                "fileId": "622098847631597568",  #测试重庆肖战科技有限公司租赁设备采购合同
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:10222",
            }
...
file_sit = [{
            ...
            {
                "fileId": "622098847631597568",  #合同公司J1租赁设备采购合同-sit
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:311225",
            },
            {
                "fileId": "624630518415298560",  #合同公司J2租赁设备采购合同-sit
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:311222",
            },
            {
                "fileId": "624630518415298560",  #合同公司Z1租赁设备采购合同-sit
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:311258",
            },
            {
                "fileId": "616222120510742528",  # F1租赁设备采购合同
                "fileName": "1693190688-origin-IMG_0082.JPG",
                "subCategoryCode": "rentalEquipProcurementContract:311261",
            },
            {
                "fileId": "624630518415298560",  #测试进秧贸易有限公司租赁设备采购合同
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:311226",
            },
            {
                "fileId": "622098847631597568",  #测试重庆肖战科技有限公司租赁设备采购合同
                "fileName": "mmexport1690803025832.jpg",
                "subCategoryCode": "rentalEquipProcurementContract:311775",
            }
        ]



def getSupplier(projectNo, custName, env, projTradesId,product):
    if env == 'sit':
        data_before = {"xzw": {"supplierId": "311258",
                       ...
                       "jxw": {"supplierId": "311258",
                               ...
                               "registerFullAddress": "120000|120100|120102;天津市|市辖区|河东区|注册地详细地址",
                               "businessAddress": "120000|120100|120102;天津市|市辖区|河东区|实际经营地址\n"},
                       "fht": {"supplierId": "311694",
                               "supplierName": "测试供应商F2",
                               "certId": "91410000170001401D",
                       ...
                       "ljy": {"supplierId": "311775",
                              "supplierName": "测试重庆肖战科技有限公司",
                              "certId": "91500106MA619UN49H",
                              "artificialPerson": "柳姣燕",
                              "registerFullAddress": "130000|130300|130304;河北省|秦皇岛市|北戴河区|测试",
                              "businessAddress": "130000|130300|130304;河北省|秦皇岛市|北戴河区|测试"}
                       }
    ...
    if product == 'I':
        data_1 = {
            ...
            "notePeriod": "01",
            "notePeriodName": "60天",
            "tradeModeReadOnly": None,
            "isTicketTake": "N",
            "isTicketTakeName": None,
            "isVoucherExemption": "N",
            "isVoucherExemptionName": None,
            "accountSupervision": "",
            "accountSupervisionName": None,
...
def getAuthData(projectNo,custName,guarantor,enterprise,creditcode,person,creditcodeperson):
    if enterprise == "" and creditcode == "":
        if custName == "jxw" :
            enterprise = "测试Z500公司J2"
            creditcode = "91310000NRNL32PU3J"

        if custName == "fht":
            enterprise = "测试软创"
            creditcode = "911101083398346103"

        if custName == "xzw":
            enterprise = "测试Z500公司X1"
            creditcode = "92469003MA5RUJ874M"

        if custName == "cm":
            enterprise = "测试苏中建设500"
            creditcode = "913200001385836169"

        if custName == "zll":
            enterprise = "测试Z500公司Z1"
            creditcode = "91420100591083185E"

        if custName == "ljy":
            enterprise = "测试北京醋溜网络科技股份有限公司"
            creditcode = "9111010806494342XT"

    if person == "" and creditcodeperson == "":
        if custName == "jxw" :
            person = "季晓伟"
            creditcodeperson = "320683199410302714"

        if custName == "fht":
            person = "范怀通"
            creditcodeperson = "412702199005284111"

        if custName == "xzw":
            person = "夏紫文"
            creditcodeperson = "410223199805229877"

        if custName == "cm":
            person = "陈鸣"
            creditcodeperson = "320621198908174349"

        if custName == "zll":
            person = "张玲玲"
            creditcodeperson = "622425199512047628"

        if custName == "ljy":
            person = "柳姣燕"
            creditcodeperson = "422325199411120520"
    ...
    if custName == 'ph_sd':
        custName = 'jxw'
    data = []
    list = ['jxw','fht','xzw','cm','zll','ljy']
    custNameList = {'jxw':{
        "businessName": enterprise,
        "businessAddress": None,
        "businessCreditCode": creditcode,
        "businessStartDate": None,
        "businessTermEndDate": None,
        "projectNo": projectNo,
        "preAprlCode": projectNo + "202311101044830161",
        "creditCustomerType": "ENT",
        "creditCustomerName": person,
        "creditCustomerTel": "15705101126",
        "creditCustomerNo": creditcodeperson,
    ...
    # custNameList[custName]["businessName"] = enterprise
    # custNameList[custName]["businessCreditCode"] = creditcode
    ...
    if guarantor == '3':
        data.append(custNameList[list[0]])
        data.append(custNameList[list[1]])
...
def getBackData(projectNo,custName,guarantor):
    ...
    custNameList = {
        'jxw':{
        "preAprlCode": projectNo + "202311101044830161",
        "ssqContractId": "3446341050225020935",
        "businessLicenceFileId": "6732675606317342720",
        "faceFileId": "6732601780120293376",
        "backFileId": "6732573806994096128",
        "source": None,
        "creditTimeout": None
    },
        'fht':{
